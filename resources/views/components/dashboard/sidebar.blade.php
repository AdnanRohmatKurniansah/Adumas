      ...
      <ul class="mt-6">
        @if (Auth::guard('petugas')->check())
          @if (Auth::guard('petugas')->user()->level == 'admin')
            <li class="relative px-6 py-3">
              {!! Request::is('dashboard/petugas*') ? '<span
              class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
              aria-hidden="true"
              ></span>' : '' !!}
              <a
          ...
          @endif
          <li class="relative px-6 py-3">
            {!! Request::is('dashboard/tanggapan*') ? '<span
            class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
            aria-hidden="true"
            ></span>' : '' !!}
            <a
            ...
            >
              ...
              <span class="ml-4">Beri tanggapan & verifikasi</span>
            </a>
          </li>
        @endif
        @if (Auth::guard('masyarakat')->check())  
          <li class="relative px-6 py-3">
            {!! Request::is('dashboard/pengaduan*') ? '<span
            class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
            aria-hidden="true"
            ></span>' : '' !!}
            <a
